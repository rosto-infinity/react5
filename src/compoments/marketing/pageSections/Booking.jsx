          ...
          <form className="grid sm:grid-cols-2 gap-x-7 gap-y-6 mt-20 ">
            ...
            <div>
              ...
              <input 
                ...
                id="name"
                autoComplete="off"
                className="focus:ring-primary focus:border-primary focus:border block w-full border-white-rosto-400 rounded-md p-5"
                placeholder="Rosto dev"
              />
            </div>
            ...
            <div>
              ...
              <input 
                ...
                name="sendBooking"
                id="sendBooking"
                className="bg-red-primary hover:bg-red-primary-hover w-full text-white-rosto font-secondary tracking-widest uppercase py-5 cursor-pointer rounded-md animate"
