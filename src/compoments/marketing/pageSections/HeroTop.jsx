        ...
        <Container>
          ...
          <div className="relative mt-10 md:mt-28 w-full">
            ...
            <div className="hidden lg:block absolute right-80 top-40 rounded-full bg-red-primary w-40 h-40 p-3">
              ...
              <div className="w-full h-full rounded-full border-2 border-dashed border-white-rosto text-white-rosto flex items-center justify-center">
          ...
          <Button className="mt-5 w-full lg:w-1/5" color="secondary" theme="big">
            Créer mon compte
          </Button>
        </Container>
      </div>
