...
const LastProducts = () => {
    return (
        <Container>
        <div className="grid grid-rows-3 lg:grid-rows-2 lg:grid-cols-2 gap-3 lg:gap-9 w-full h-96 md:h-full lg:h-96 lg:px-11 my-20 text-white-rosto uppercase">
  
          <div className="relative bg-primary lg:row-span-2 h-full rounded-md p-5 md:p-10 lg:p-7">
            <img src={Image1} className="absolute top-0 left-0 w-full h-full object-cover z-0 rounded-md" alt="Un délicieux hamburger exposé sur une pièce de boit" />
          ...
          <div className="relative bg-primary h-full rounded-md p-5 md:p-10 lg:p-7">
            <img src={Image2} className="absolute top-0 left-0 w-full h-full object-cover z-0 rounded-md" alt="Deux délicieux hamburger exposé sur une pièce de boit" />
            <div className="relative z-10">
          ...
          <div className="relative bg-primary h-full rounded-md p-5 md:p-10 lg:p-7">
            <img src={Image3} className="absolute top-0 left-0 w-full h-full object-cover z-0 rounded-md" alt="Un délicieux hamburger exposé sur une pièce de boit" />
            <div className="relative z-10">
